...
__all__ = ['ceph_mds_laggy_since']

# ceph mds dump --format json
# ['info'][gid_N]['laggy_since'] => ceph_mds_laggy_since{fsid="$fsid",gid="$gid",rank="$rank",name="$name"}

ceph_mds_laggy_since = Metric('ceph_mds_laggy_since', None, 'gauge')
