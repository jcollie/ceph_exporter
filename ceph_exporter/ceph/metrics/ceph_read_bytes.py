...
__all__ = ['ceph_read_bytes']

# ceph pg dump --format json
# ['pg_stats_sum']['stat_sum']['num_read_kb'] => ceph_read_bytes{fsid="$fsid",scope="cluster")
# ['pg_stats'][n]['stat_sum']['num_read_kb'] => ceph_read_bytes{fsid="$fsid",scope="pg",pgid="$pgid")

ceph_read_bytes = Metric('ceph_read_bytes', None, 'counter')
