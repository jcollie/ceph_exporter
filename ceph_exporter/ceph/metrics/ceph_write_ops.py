...
__all__ = ['ceph_write_ops']

# ceph pg dump --format json
# ['pg_stats_sum']['stat_sum']['num_write'] => ceph_write_ops{fsid="$fsid",scope="cluster")
# ['pg_stats'][n]['stat_sum']['num_write'] => ceph_write_ops{fsid="$fsid",scope="pg",pgid="$pgid")

ceph_write_ops = Metric('ceph_write_ops', None, 'counter')
