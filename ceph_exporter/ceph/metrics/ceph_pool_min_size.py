...
__all__ = ['ceph_pool_min_size']

# ceph osd dump --format json
# ['pools'][n]['min_size'] => ceph_pool_min_size{fsid="$fsid",pool="$pool_id",name="$pool_name"}

ceph_pool_min_size = Metric('ceph_pool_min_size', None, 'gauge')
