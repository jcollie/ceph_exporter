...
__all__ = ['ceph_read_ops']

# ceph pg dump --format json
# ['pg_stats_sum']['stat_sum']['num_read'] => ceph_read_ops{fsid="$fsid",scope="cluster")
# ['pg_stats'][n]['stat_sum']['num_read'] => ceph_read_ops{fsid="$fsid",scope="pg",pgid="$pgid")

ceph_read_ops = Metric('ceph_read_ops', None, 'counter')
